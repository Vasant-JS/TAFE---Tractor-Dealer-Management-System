...
export const sampleVehicles = [
  ...
  { code: 'VEH-2026-00042', engine: 'TAF2502EN7813', chassis: 'TAFCH2502X992', model: 'TAFE 6028 M', status: 'Pending Installation' },
...
export const modules: ModuleConfig[] = [
  ...
  },
  {
    ...
    vehicleStatus: 'Pending Installation',
    kpis: [
    ...
    workflow: ['Select invoice', 'Fetch vehicles with Pending PDI status', 'Complete configurable checklist', 'Verify inspector OTP', 'Move vehicle to Pending Installation'],
  ...
  },
  {
    ...
    workflow: ['Select PDI-cleared vehicle', 'Register or select customer', 'Verify customer OTP', 'Capture signature', 'Store certificate PDF'],
  ...
  },
  {
    ...
    fields: ['Customer Aadhaar', 'Bonafide Certificate Number', 'Form 20', 'Form 21', 'Form 22', 'Tax Receipt', 'Dealer Authorization', 'RTO Clerk'],
    ...
    documents: ['Form 20', 'Form 21', 'Form 22', 'Tax receipt', 'RC copy', 'Address proof', 'Shaddow Trace'],
    rows: baseRows,
  },
  {
    key: 'insurance',
    ...
    workflow: ['Attach policy after RTO packet', 'Validate period', 'Upload insurance copy', 'Schedule renewal reminders', 'Expose delivery copy'],
